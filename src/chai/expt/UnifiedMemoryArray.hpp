...
namespace expt {
   ...
   *
   * \code
   * #include "chai/UnifiedMemoryArray.hpp"
   ...
   *
   * int size = 10000;
   * chai::UnifiedMemoryArray<int> a(size);
   *
   * int offset = 42;
   *
  ...
  class UnifiedMemoryArray {
    public:
       ...
       */
      constexpr UnifiedMemoryArray() noexcept = default;
      ...
      explicit UnifiedMemoryArray(UnifiedMemoryManager* manager)
        : m_manager{manager}
      {
        if (m_manager)
        {
       ...
       */
      CHAI_HOST_DEVICE UnifiedMemoryArray(const UnifiedMemoryArray& other) :
        m_data{other.m_data},
        m_size{other.m_size}
      ...
      /*!
       * \brief Sets the array manager for this UnifiedMemoryArray.
       *
       * \param manager The new array manager to be set.
       *
       * \post The UnifiedMemoryArray takes ownership of the new manager objet.
       */
      ...
      /*!
       * \brief Get the array manager associated with this UnifiedMemoryArray.
       *
       ...
       *
       * \throw std::runtime_exception if the array manager is not associated with the UnifiedMemoryArray.
       */
