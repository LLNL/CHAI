...
#ifndef CHAI_PINNED_MEMORY_MANAGER_HPP
#define CHAI_PINNED_MEMORY_MANAGER_HPP
...
namespace expt {
  ...
  class PinnedMemoryManager : public ArrayManager<ElementT> {
    public:
      /*!
       * Constructs a PinnedMemoryManager with default allocators from Umpire
       * for the "HOST" and "DEVICE" resources.
       */
      PinnedMemoryManager() = default;

      /*!
       * Constructs a PinnedMemoryManager with the given Umpire allocators.
       */
      PinnedMemoryManager(const umpire::Allocator& allocator) 
      ...
      /*!
       * Constructs a PinnedMemoryManager with the given Umpire allocator IDs.
       */
      PinnedMemoryManager(int allocatorID)
        : ArrayManager<ElementT>{},
      ...
      /*!
       * Constructs a PinnedMemoryManager with the given size using default allocators
       * from Umpire for the "HOST" and "DEVICE" resources.
       */
      PinnedMemoryManager(std::size_t size)
        : ArrayManager<ElementT>{},
          m_size{size}
      {
      ...
      /*!
       * Constructs a PinnedMemoryManager with the given size using the given Umpire
       * allocators.
       */
      PinnedMemoryManager(std::size_t size,
      ...
      /*!
       * Constructs a deep copy of the given PinnedMemoryManager.
       */
      PinnedMemoryManager(const PinnedMemoryManager& other)
        : ArrayManager<ElementT>{},
      ...
      /*!
       * Constructs a PinnedMemoryManager that takes ownership of the
       * resources from the given PinnedMemoryManager.
       */
      PinnedMemoryManager(PinnedMemoryManager&& other) noexcept
        : ArrayManager<ElementT>{},
          m_allocator{other.m_allocator},
          m_size{other.m_size},
          m_touch{other.m_touch},
       ...
       */
      PinnedMemoryManager& operator=(const PinnedMemoryManager& other)
      {
        if (this != &other)
        {
       ...
       */
      PinnedMemoryManager& operator=(PinnedMemoryManager&& other) noexcept
      {
        if (this != &other)
        {
...
#endif  // CHAI_PINNED_MEMORY_MANAGER_HPP
