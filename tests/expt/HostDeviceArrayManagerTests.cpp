...
enum class HostDeviceArrayManagerState
{
  ALLOCATED_NONE,
  ALLOCATED_HOST,
  ALLOCATED_DEVICE,
  ALLOCATED_HOST_MODIFIED_HOST,
  ALLOCATED_DEVICE_MODIFIED_DEVICE,
  ALLOCATED_BOTH,
  ALLOCATED_BOTH_MODIFIED_HOST,
  ALLOCATED_BOTH_MODIFIED_DEVICE
}

class HostDeviceArrayManagerTest : public ::testing::Test
{
  protected:
    ...
    void SetArrayManagerState(ArrayManagerState)

    std::size_t m_size = 10;
};

class HostDeviceArrayManager_AllocatedNone_Test : public ::testing::Test
{
  protected:
    chai::expt::HostDeviceArrayManager<int> m_array{};
};

class HostDeviceArrayManager_AllocatedHost_Test : public ::testing::Test
{
  protected:
    void SetUp() override
    {
      GetContextManager().reset();
      GetContextManager().setContext(chai::expt::Context::HOST);
...
TEST_F(HostDeviceArrayManagerTest, AllocatorConstructor)
{
  for (ContextManagerState context_manager_state : GetContextManagerStates())
  {
    SetContextManagerState(context_manager_state);
    chai::expt::HostDeviceArrayManager<int> array(GetCustomHostAllocator(), GetCustomDeviceAllocator());
    EXPECT_EQ(array.size(), 0);
    EXPECT_EQ(array.modified(), chai::expt::Context::NONE);
    EXPECT_EQ(array.host_data(), nullptr);
    EXPECT_EQ(array.device_data(), nullptr);
...
TEST_F(HostDeviceArrayManagerTest, SizeConstructor)
{
  for (ContextManagerState context_manager_state : GetContextManagerStates())
  {
    SetContextManagerState(context_manager_state);
    chai::expt::HostDeviceArrayManager<int> array(m_size);
...
TEST_F(HostDeviceArrayManagerTest, SizeAndAllocatorConstructor)
{
...
TEST_F(HostDeviceArrayManagerTest, CopyConstructor) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array1(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
  ...
  chai::expt::HostDeviceArrayManager<int> array2(array1);
...
TEST_F(HostDeviceArrayManagerTest, MoveConstructor) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array1(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
  ...
  chai::expt::HostDeviceArrayManager<int> array2(std::move(array1));
...
TEST_F(HostDeviceArrayManagerTest, CopyAssignment) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array1(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
  ...
  chai::expt::HostDeviceArrayManager<int> array2;
  array2 = array1;
...
TEST_F(HostDeviceArrayManagerTest, MoveAssignment) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array1(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST_F(HostDeviceArrayManagerTest, Resize) {
  chai::expt::HostDeviceArrayManager<int> array(5, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST_F(HostDeviceArrayManagerTest, ResizeWithData) {
  const size_t initial_size = 5;
  chai::expt::HostDeviceArrayManager<int> array(initial_size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST_F(HostDeviceArrayManagerTest, Free) {
  chai::expt::HostDeviceArrayManager<int> array(5, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST_F(HostDeviceArrayManagerTest, DataAndModified) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST_F(HostDeviceArrayManagerTest, ConstData) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
  ...
  const chai::expt::HostDeviceArrayManager<int>& const_array = array;
...
TEST_F(HostDeviceArrayManagerTest, GetAndSet) {
  const size_t size = 5;
  chai::expt::HostDeviceArrayManager<int> array(size, GetCustomHostAllocator(), GetCustomDeviceAllocator());
...
TEST(HostDeviceArrayManager, DefaultConstructor_ContextNone_DeviceSynchronized)
{

  HostDeviceArrayManager<int> manager;
